-- ============================================================
-- Ausgabenverwaltung – Schema Version 2
--
-- Massgebliches Schema fuer NEUE Datenbanken. Bestehende
-- Datenbanken der Version 1 werden nicht mit dieser Datei
-- angelegt, sondern mit docs/migration_v1_to_v2.sql
-- hochgezogen. Beide Wege muessen zum selben Ergebnis fuehren
-- (siehe DatabaseMigratorTests).
--
-- Unterschied zu Version 1: Category.Color.
--
